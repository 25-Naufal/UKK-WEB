...
<form method="POST" action="fungsi/edit/edit.php?meja=edit">
    <table>
        <tr>
            <td style="width:25pc;"><input type="text" class="form-control" value="<?= $edit['nama_meja'];?>"
                    required name="meja" placeholder="Masukan Meja Baru">
...
<form method="POST" action="fungsi/tambah/tambah.php?meja=tambah">
    <table>
        <tr>
            <td style="width:25pc;"><input type="text" class="form-control" required name="meja"
                    placeholder="Masukan Meja Baru"></td>
        ...
        <table class="table table-bordered table-striped table-sm" id="example1">
			...
			?>
                <tr>
                    ...
                    <td>
                        <a href="index.php?page=meja&uid=<?php echo $isi['id_meja'];?>"><button
                                class="btn btn-warning">Edit</button></a>
                        <a href="fungsi/hapus/hapus.php?meja=hapus&id=<?php echo $isi['id_meja'];?>"
                            onclick="javascript:return confirm('Hapus Data meja ?');"><button
